...
public class ValiderAmis extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			statement.executeUpdate("INSERT INTO `ami` VALUES ('"+pseudo_session+"','"+pseudoDemandeAccepte+"')");
			statement.executeUpdate("UPDATE `demandeami` SET `Etat`='Valide' WHERE `Login`='"+pseudoDemandeAccepte+
